...
public class RepositoryModule {
    @RepositoryScope
    @Provides
    public AppRepository providesAppRepository(ServerCommunicator communicator, WorkerDao workerDao, SpecialtyDao specialtyDao) {
        return new AppRepository(communicator, workerDao, specialtyDao);
    }
}